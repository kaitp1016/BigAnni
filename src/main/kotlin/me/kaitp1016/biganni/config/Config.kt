...
object Config {
    ...
    data class MapConfig(val name: String, val phaseTime: Int, val bossPortals: List<LevelBlockPos>, val bossLocation: Location,val teams: List<TeamConfig>,val blockedClasses:List<String>) {
        companion object {
